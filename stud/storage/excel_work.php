...
function work_back()
{
  ...
  if ($_SESSION["second_name"] == "orders_elena")
  {
    $src_str = "/storage/data/dar.xls";
  }
  else if ($_SESSION["name"] == "orders_mh")
  {
    $src_str = "/storage/data/dar_mh.xls";
  }
  else if($_SESSION["name"] == "orders_garden")
  {
    $src_str = "/storage/data/dar_garden.xls";
  }
  else if($_SESSION["name"] == "orders")
  {
    $src_str = "/storage/data/dar_kruiz.xls";
  }
  else if($_SESSION["name"] == "orders_td")
  {
    $src_str = "/storage/data/dar_td.xls";
  }
